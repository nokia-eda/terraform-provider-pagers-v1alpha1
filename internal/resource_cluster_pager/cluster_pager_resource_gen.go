...
package resource_cluster_pager
...
func ClusterPagerResourceSchema(ctx context.Context) schema.Schema {
		...
		Attributes: map[string]schema.Attribute{
			...
			"api_version": schema.StringAttribute{
				...
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^pagers\\.eda\\.nokia\\.com/v1alpha1$"), ""),
				},
				Default: stringdefault.StaticString("pagers.eda.nokia.com/v1alpha1"),
			},
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ClusterPager$"), ""),
				},
				Default: stringdefault.StaticString("ClusterPager"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the ClusterPager",
			},
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ClusterPagerSpec defines the desired state of ClusterPager",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ClusterPagerStatus defines the observed state of ClusterPager",
			},
		},
	}
}

type ClusterPagerModel struct {
