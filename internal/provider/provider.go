...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-pagers/internal/eda/utils"
...
var _ provider.Provider = (*pagersProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &pagersProvider{version: ver}
	}
}

type pagersProvider struct {
	version string
}
...
func (p *pagersProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *pagersProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *pagersProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "pagers-v1alpha1"
	resp.Version = p.version
}

func (p *pagersProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewClusterPagerDataSource,
		NewClusterPagerListDataSource,
		NewPagerDataSource,
		NewPagerListDataSource,
		NewResourceListDataSource,
	}
}

func (p *pagersProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewClusterPagerResource,
		NewPagerResource,
	}
}
