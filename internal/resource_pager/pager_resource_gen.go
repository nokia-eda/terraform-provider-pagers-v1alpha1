...
func PagerResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^Pager$"), ""),
				},
				Default: stringdefault.StaticString("Pager"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the Pager",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
